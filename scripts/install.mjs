...
const dir = join(process.env.XDG_CONFIG_HOME || join(homedir(), '.config'), 'opencode', 'plugins');
...
try {
  ...
  if (!old.startsWith('// Installed by opencode-jev-supervisor.')) throw new Error('Refusing to overwrite an unrelated existing plugin');
